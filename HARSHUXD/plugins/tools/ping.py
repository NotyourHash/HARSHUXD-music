...
from HARSHUXD.utils.decorators.language import language
from HARSHUXD.utils.inline import supp_markup
...
async def ping_com(client, message: Message, _):
    ...
    reply_markup=InlineKeyboardMarkup(
        ...
        [
            InlineKeyboardButton(
                text="✦ ɢʀᴏᴜᴘ ✦", url=f"https://t.me/EquinoxLogs",
            ),
            InlineKeyboardButton(
                text="✧ ᴍᴏʀᴇ ✧", url=f"https://t.me/EquinoxNetwork",
            )
        ],
        [
            InlineKeyboardButton(
